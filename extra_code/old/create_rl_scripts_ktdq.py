...
def main():
    create_policies_filename = '../scripts/create_policies_ktdq.sh'
    condor_submit_init_filename = '../scripts/condor_submit_init_ktdq.sh'
    condor_submit_train_filename = '../scripts/condor_submit_train_ktdq.sh'
    condor_submit_test_filename = '../scripts/condor_submit_test_ktdq.sh'
