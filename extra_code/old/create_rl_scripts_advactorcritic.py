...
def get_agent_name(model_type, gamma, beam_size, guess_predictor, on_topic, alpha):
    agent_name = 'advactorcritic_' + model_type + '_gamma' + re.sub('\.', '_', str(gamma)) \
...
def create_condor_script(filename, script_to_run, args_str):
    ...
    condor_script_file.write('JobBatchName = "Adv Actor Critic - RL for OAL"\n')
...
def main():
    create_policies_filename = '../scripts/create_policies_advactorcritic.sh'
    condor_submit_init_filename = '../scripts/condor_submit_init_advactorcritic.sh'
    condor_submit_train_filename = '../scripts/condor_submit_train_advactorcritic.sh'
    condor_submit_test_filename = '../scripts/condor_submit_test_advactorcritic.sh'
