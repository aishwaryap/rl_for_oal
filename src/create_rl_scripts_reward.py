...
def main():
    create_policies_filename = '../scripts/create_policies_reward.sh'
    condor_submit_init_filename = '../scripts/condor_submit_init_reward.sh'
    condor_submit_train_filename = '../scripts/condor_submit_train_reward.sh'
    condor_submit_test_filename = '../scripts/condor_submit_test_reward.sh'
