...
def get_agent_name(model_type, gamma, beam_size, guess_predictor, on_topic):
...
def main():
    create_policies_filename = '../scripts/create_policies_fixedlen.sh'
    condor_submit_init_filename = '../scripts/condor_submit_init_fixedlen.sh'
    condor_submit_train_filename = '../scripts/condor_submit_train_fixedlen.sh'
    condor_submit_test_filename = '../scripts/condor_submit_test_fixedlen.sh'
